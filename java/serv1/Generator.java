...
public class Generator {
    ...
    public void GenerateDate(Record record){
    ...
    public void GenerateName(Record record){
        record.setName("Ship " + (int)(Math.random()*1001));
    }

    public void GenerateTypeOfCargo(Record record) {
    ...
    public void GenerateCargoWeight(Record record){
        record.setCargoWeight(10 + (int)(Math.random()*3000000));
    }
