...
public class StatToJson {
    ...
    public static void ScheduleToJson(Schedule schedule) throws IOException {
        ...
        String pathJsonForSched = "C:\\Users\\alena\\IdeaProjects\\KursStep2\\src\\resources\\Schedule.json";

        FileWriter fileWriter = new FileWriter(pathJsonForSched);
    ...
    public static void SumStatToJson(SumStat stat) throws IOException {
        String pathForStat  = "C:\\Users\\alena\\IdeaProjects\\KursStep2\\src\\resources\\SumStat.json";

        FileWriter fileWriter = new FileWriter(pathForStat);
        JsonWriter jsonWriter = new JsonWriter(fileWriter);
